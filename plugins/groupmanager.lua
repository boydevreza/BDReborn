...
برای قفل ادیت از دستور زیر استفاده کنید
/lockedit
—-----------------
...
برای روشن کردن خوشآمدگویی دستور
/welcome on
را ارسال کنید, و برای غیرفعال کردن آن
/welcome off
...
استفاده کنید 
مثال:
/set weclome سلام {name} خوش اومدی

برای مشاهده متن خوشآمدگویی که قبل تنظیم کردید از دستور
/‌get welcome
استفاده کنید و برای حذف آن 
/del welcome
را ارسال نمایید.
